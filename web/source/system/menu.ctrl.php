...
$not_show_menu = array('site', 'system', 'account_manage', 'module_manage', 'permission', 'user_manage', 'workorder', 'appmarket');
...
if ('display' == $do) {
	...
	$menu = array(
		...
		'permission_name' => safe_gpc_string($_GPC['permissionName']),
		'is_system' => intval($_GPC['isSystem']),
