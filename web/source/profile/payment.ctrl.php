...
if ('display' == $do || 'switch' == $do) {
	...
	$pay_setting = payment_setting();
	foreach ($pay_setting as $pay_type => $setting) {
		if (isset($setting['recharge_switch'])) {
			$pay_setting[$pay_type]['recharge_switch'] = false == $setting['recharge_switch'] ? false : true;
		}
		if (isset($setting['pay_switch'])) {
			$pay_setting[$pay_type]['pay_switch'] = false == $setting['pay_switch'] ? false : true;
		}
	}
