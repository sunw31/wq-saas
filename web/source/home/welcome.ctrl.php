...
$dos = array('platform', 'system', 'ext', 'account_ext', 'get_fans_kpi', 'get_system_upgrade', 'get_upgrade_modules', 'get_module_statistics', 'get_not_installed_modules', 'system_home', 'set_top', 'set_default', 'add_welcome', 'ignore_update_module', 'add_welcome_shortcut', 'remove_welcome_shortcut', 'build_account_modules');
...
if ('ext' == $do) {
	...
	if ($_GPC['system_welcome']) {
		...
		if ('store' != $module_name && empty($_W['current_module']['main_module']) || STATUS_ON == $_GPC['tohome']) {
