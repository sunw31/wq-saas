...
<head>
	...
	window.sysinfo = {
		...
		'isadmin': <?php  if(!empty($_W['isadmin'])) { ?>1<?php  } else { ?>0<?php  } ?>,
		'family': '<?php echo IMS_FAMILY;?>',
		'siteroot': '<?php  echo $_W['siteroot'];?>',
		'siteurl': '<?php  echo $_W['siteurl'];?>',
		'attachurl': '<?php  echo $_W['attachurl'];?>',
		'attachurl_local': '<?php  echo $_W['attachurl_local'];?>',
		'attachurl_remote': <?php  if(!empty($_W['attachurl_remote'])) { ?>'<?php  echo $_W['attachurl_remote'];?>'<?php  } else { ?>''<?php  } ?>,
		...
		'account' : <?php  if(!empty($_W['account'])) { ?><?php  echo json_encode($_W['account'])?><?php  } else { ?>''<?php  } ?>,
...
<body class="<?php  if($_W['isw7_sign']) { ?>body-iframe<?php  } ?>">
